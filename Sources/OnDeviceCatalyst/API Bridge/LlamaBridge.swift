...
public enum LlamaBridge {
    ...
    public static func getKVCacheUsedCells(_ context: CContext) -> Int32 {
        // Not available, return 0
        return 0
    }

    /// Get token count in KV cache (approximation)
    public static func getKVCacheTokenCount(_ context: CContext) -> Int32 {
        // Not available, return 0
        return 0
    }
