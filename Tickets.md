...
| ODC-0004 | test | V2 characterization suite | P0 | DONE | P0 | ODC-0002 | [spec](docs/specs/ODC-0004-v2-characterization-suite.md) | TBD | SankrityaT | 2026-09-01 | complete; 29 of 34 execute, 5 R3 cases inert pending ODC-0021 |
...
| ODC-0011 | bug | Generation emits duplicate terminal completions (D2) | P0 | REVISION | P1 | ODC-0002, ODC-0004 | [spec](docs/specs/ODC-0011-duplicate-terminal-completions.md) | TBD | unassigned | 2026-09-01 | resolve blocking review findings |
| ODC-0012 | bug | Loading stream never terminates, impossible gate (D3) | P0 | APPROVED | P1 | ODC-0002, ODC-0004 | [spec](docs/specs/ODC-0012-loading-stream-never-terminates.md) | TBD | unassigned | 2026-09-01 | implementation, lands first per ordering hazard |
...
| ODC-0015 | bug | Fallback-path progress events are silent no-ops (D8) | P0 | REVISION | P1 | ODC-0002, ODC-0004, ODC-0012 | [spec](docs/specs/ODC-0015-fallback-events-dropped.md) | TBD | unassigned | 2026-09-01 | resolve blocking review findings |
...
| ODC-0018 | bug | Declared test target does not compile on any triple (PredictionConfig.quality) | P0 | DONE | P0 | ODC-0002 | [spec](docs/specs/ODC-0018-test-target-compile-failure.md) | TBD | SankrityaT | 2026-09-01 | complete |
